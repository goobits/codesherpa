/**
 * Code review functionality - can be used via CLI or MCP
 */
...
${formattedContent}`;
  ...
  const systemPrompt =
    focus === "architecture" ? ARCHITECTURE_SYSTEM : CODE_REVIEW_SYSTEM;
...
export const reviewTool = {
  name: "review",
  description: "Review code files, diffs, or prompts with LLM",
  inputSchema: {
